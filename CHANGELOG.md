...
- Added Play Games Recall account recovery backed by Firebase Authentication and a free-tier Cloudflare Worker.
...
- **ProGuard/R8 obfuscation enabled** for release builds to protect code and reduce APK size
- Comprehensive ProGuard rules for all dependencies (Kotlin, Compose, Firebase, AdMob, DataStore)
- Privacy policy updated with contact information and current date
- Store listing information completed for Google Play Store submission
